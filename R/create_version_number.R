...
create_version_number <- function(download_date = NULL,
  ...
  if(!is.null(download_date)){
    ...
    # allow YYYYMMDD and allow DDMMYYYY but only if the year contains 20xx or 19xx
    # warn if DDMMYYYY as this will be reversed
    ...
    # Do not allow DDMMYY or YYMMDD as no way to tell which way round the date is
