...
rhdf5::h5createGroup(h5filename, "rawdata")
# Create subgroup for raw population data
rhdf5::h5createGroup(h5filename, "rawdata/scotlandpopulations")
# Create subgroup for SIMD deprivation data
rhdf5::h5createGroup(h5filename, "rawdata/SIMD")

# Create group for processed data
rhdf5::h5createGroup(h5filename, "processeddata")
# Create subgroup for processed population data
rhdf5::h5createGroup(h5filename, "processeddata/scotlandpopulations_single_year")
...
rhdf5::h5write(sape_persons, file = h5filename,
        name = file.path("rawdata/scotlandpopulations", "datazone_population_persons_singleyear_2018"))
...
h5write(sape_persons, file = h5filename, 
        name = file.path("processeddata/scotlandpopulations_single_year",
                         "datazone_population_persons_singleyear_2018"))
