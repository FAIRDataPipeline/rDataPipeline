...
query_4 <- 5
query_5 <- NULL
query_6 <- list(storage_location = "https://data.scrc.uk/api/storage_location/2", storage_root = "")
...
test_that("clean_query produces correct results", {
  ...
  testthat::expect_equal(clean_query(query_6), list(storage_location = "2", storage_root = NULL))
})
