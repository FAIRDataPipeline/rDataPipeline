...
datazones <- datazones[-which(is.na(match(datazones$DataZone,empty.datazones))==FALSE),]
...
postcode_in_and_out[which(is.na(postcode_in_and_out$grid_id)==TRUE),]
postcode_in_and_out[which(postcode_in_and_out$DZ11=="S01007285"),]
...
#save to hdf file
h5write(grid_populations, file="scrc_demographics.h5", name="griddata/5year_age_class_scotland_10kmgrid_postcode")
